...
class PostinganDetailPenerimaDonasi extends StatefulWidget {
  final String userId;

  const PostinganDetailPenerimaDonasi({super.key, required this.userId});

  @override
  // ignore: library_private_types_in_public_api
  _PostinganDetailPenerimaDonasiState createState() =>
      _PostinganDetailPenerimaDonasiState();
}

class _PostinganDetailPenerimaDonasiState
    extends State<PostinganDetailPenerimaDonasi> {
  @override
  Widget build(BuildContext context) {
    // Hapus pengecekan user login karena kita akan menampilkan postingan berdasarkan userId yang diberikan
